...
function app() {
	...
	var AppView = _react2.default.createClass({
		displayName: "AppView",
		//<= similar to Backbone.extend
		render: function render() {
			//<= built-in keyword
			return _react2.default.createElement(
				"div",
				{ className: "pageContainer" },
				_react2.default.createElement(HeaderElement, null),
				_react2.default.createElement(SearchElement, null),
				_react2.default.createElement(ArticleElement, null),
				_react2.default.createElement(FollowPosts, null)
			);
		}
	});

	var HeaderElement = _react2.default.createClass({
		...
		render: function render() {
			return (//<= must return only one parent element, though it can have many children
				_react2.default.createElement(
					...
					_react2.default.createElement("img", { id: "skyline", src: "./images/houston-skyline.jpg" }),
					_react2.default.createElement("img", { id: "circle-logo", src: "./images/ironyardlogo.png" })
				)
			);
		}
	});

	var SearchElement = _react2.default.createClass({
		displayName: "SearchElement",

		render: function render() {
			return _react2.default.createElement(
				"div",
				{ className: "searchEl-container" },
				_react2.default.createElement(
					"p",
					{ id: "search-title" },
				...
				_react2.default.createElement("input", { placeholder: "Search Keywords" })
			);
		}

	});

	var ArticleElement = _react2.default.createClass({
		displayName: "ArticleElement",

		render: function render() {
			return _react2.default.createElement(
				"div",
				{ className: "articleEl-container" },
				_react2.default.createElement(
					"p",
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						"a",
						{ herf: "https://www.theironyard.com" },
						"The Iron Yard"
					),
					" Houston"
				),
				_react2.default.createElement("img", { src: "./images/classroom.jpg" }),
				_react2.default.createElement(
					"p",
	...
	var FollowPosts = _react2.default.createClass({
		displayName: "FollowPosts",
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement("img", { src: "./images/ironyardlogo.png" }),
				_react2.default.createElement(
					"p",
					{ id: "tiyhouston" },
					"tiyhouston"
